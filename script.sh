...
#$ -o /srv/glusterfs/rheiki/logs/GP-WGAN.txt
...
cd /srv/glusterfs/rheiki/chainer-gan-lib/

# split out params
echo "$@"

# start training script
python train.py --gpu 1 --algorithm wgan_gp --out result_wgan_gp --n_dis 5 --lam 10
